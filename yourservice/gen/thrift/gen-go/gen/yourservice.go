...
//  - ChildValue
type Child struct {
  ChildValue int64 `thrift:"childValue,1" db:"childValue" json:"childValue"`
}
...
func (p *Child) GetChildValue() int64 {
  return p.ChildValue
}
...
func (p *Child) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("childValue", thrift.I64, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:childValue: ", p), err) }
  if err := oprot.WriteI64(int64(p.ChildValue)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.childValue (1) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 1:childValue: ", p), err) }
  return err
}
...
type TestProtoResponse struct {
  ...
  Int32Value int32 `thrift:"int32Value,3" db:"int32Value" json:"int32Value"`
  Int64Value int64 `thrift:"int64Value,4" db:"int64Value" json:"int64Value"`
  C1 *Child `thrift:"c1,5" db:"c1" json:"c1"`
  C2 *Child `thrift:"c2,6" db:"c2" json:"c2"`
  Int64Slice []int64 `thrift:"int64Slice,7" db:"int64Slice" json:"int64Slice"`
  Childs []*Child `thrift:"childs,8" db:"childs" json:"childs"`
}

func NewTestProtoResponse() *TestProtoResponse {
  return &TestProtoResponse{}
}

var TestProtoResponse_Values_DEFAULT *CommonValues
func (p *TestProtoResponse) GetValues() *CommonValues {
  if !p.IsSetValues() {
    return TestProtoResponse_Values_DEFAULT
  }
return p.Values
}

func (p *TestProtoResponse) GetStringValue() string {
  return p.StringValue
}

func (p *TestProtoResponse) GetInt32Value() int32 {
  return p.Int32Value
}

func (p *TestProtoResponse) GetInt64Value() int64 {
  return p.Int64Value
}
var TestProtoResponse_C1_DEFAULT *Child
func (p *TestProtoResponse) GetC1() *Child {
  if !p.IsSetC1() {
    return TestProtoResponse_C1_DEFAULT
  }
return p.C1
}
var TestProtoResponse_C2_DEFAULT *Child
func (p *TestProtoResponse) GetC2() *Child {
  if !p.IsSetC2() {
    return TestProtoResponse_C2_DEFAULT
  }
return p.C2
}

func (p *TestProtoResponse) GetInt64Slice() []int64 {
  return p.Int64Slice
}

func (p *TestProtoResponse) GetChilds() []*Child {
  return p.Childs
}
func (p *TestProtoResponse) IsSetValues() bool {
  return p.Values != nil
}

func (p *TestProtoResponse) IsSetC1() bool {
  return p.C1 != nil
}

func (p *TestProtoResponse) IsSetC2() bool {
  return p.C2 != nil
}

func (p *TestProtoResponse) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *TestProtoResponse)  ReadField1(iprot thrift.TProtocol) error {
...
func (p *TestProtoResponse)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TestProtoResponse)  ReadField3(iprot thrift.TProtocol) error {
...
func (p *TestProtoResponse)  ReadField4(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
...
func (p *TestProtoResponse)  ReadField5(iprot thrift.TProtocol) error {
  p.C1 = &Child{}
  if err := p.C1.Read(iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.C1), err)
  }
  return nil
}

func (p *TestProtoResponse)  ReadField6(iprot thrift.TProtocol) error {
  p.C2 = &Child{}
  if err := p.C2.Read(iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.C2), err)
  }
  return nil
}

func (p *TestProtoResponse)  ReadField7(iprot thrift.TProtocol) error {
...
var _elem0 int64
    ...
    p.Int64Slice = append(p.Int64Slice, _elem0)
  }
...
func (p *TestProtoResponse)  ReadField8(iprot thrift.TProtocol) error {
  _, size, err := iprot.ReadListBegin()
  if err != nil {
    return thrift.PrependError("error reading list begin: ", err)
  }
  tSlice := make([]*Child, 0, size)
  p.Childs =  tSlice
  for i := 0; i < size; i ++ {
    _elem1 := &Child{}
    ...
    p.Childs = append(p.Childs, _elem1)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *TestProtoResponse) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("TestProtoResponse"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(oprot); err != nil { return err }
...
func (p *TestProtoResponse) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *TestProtoResponse) writeField2(oprot thrift.TProtocol) (err error) {
...
func (p *TestProtoResponse) writeField3(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("int32Value", thrift.I32, 3); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:int32Value: ", p), err) }
  if err := oprot.WriteI32(int32(p.Int32Value)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.int32Value (3) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 3:int32Value: ", p), err) }
  return err
}

func (p *TestProtoResponse) writeField4(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("int64Value", thrift.I64, 4); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:int64Value: ", p), err) }
  if err := oprot.WriteI64(int64(p.Int64Value)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.int64Value (4) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 4:int64Value: ", p), err) }
  return err
}

func (p *TestProtoResponse) writeField5(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("c1", thrift.STRUCT, 5); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:c1: ", p), err) }
  if err := p.C1.Write(oprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error writing struct: ", p.C1), err)
  }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 5:c1: ", p), err) }
  return err
}

func (p *TestProtoResponse) writeField6(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("c2", thrift.STRUCT, 6); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:c2: ", p), err) }
  if err := p.C2.Write(oprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error writing struct: ", p.C2), err)
  }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 6:c2: ", p), err) }
  return err
}

func (p *TestProtoResponse) writeField7(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("int64Slice", thrift.LIST, 7); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:int64Slice: ", p), err) }
  if err := oprot.WriteListBegin(thrift.I64, len(p.Int64Slice)); err != nil {
    return thrift.PrependError("error writing list begin: ", err)
  }
  for _, v := range p.Int64Slice {
  ...
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 7:int64Slice: ", p), err) }
  return err
}

func (p *TestProtoResponse) writeField8(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("childs", thrift.LIST, 8); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 8:childs: ", p), err) }
  ...
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 8:childs: ", p), err) }
  return err
}

func (p *TestProtoResponse) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TestProtoResponse(%+v)", *p)
}
...
type YourService interface {
  ...
  TestProto() (r *TestProtoResponse, err error)
}
...
func (p *YourServiceClient) TestProto() (r *TestProtoResponse, err error) {
  if err = p.sendTestProto(); err != nil { return }
  return p.recvTestProto()
}

func (p *YourServiceClient) sendTestProto()(err error) {
  oprot := p.OutputProtocol
  if oprot == nil {
    oprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.OutputProtocol = oprot
  ...
  p.SeqId++
  if err = oprot.WriteMessageBegin("testProto", thrift.CALL, p.SeqId); err != nil {
      return
  }
  args := YourServiceTestProtoArgs{
  }
  if err = args.Write(oprot); err != nil {
      return
  }
...
func (p *YourServiceClient) recvTestProto() (value *TestProtoResponse, err error) {
  iprot := p.InputProtocol
  if iprot == nil {
    iprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.InputProtocol = iprot
  ...
  if method != "testProto" {
    err = thrift.NewTApplicationException(thrift.WRONG_METHOD_NAME, "testProto failed: wrong method name")
    return
  }
  if p.SeqId != seqId {
    err = thrift.NewTApplicationException(thrift.BAD_SEQUENCE_ID, "testProto failed: out of sequence response")
    return
  }
  if mTypeId == thrift.EXCEPTION {
  ...
  if mTypeId != thrift.REPLY {
    err = thrift.NewTApplicationException(thrift.INVALID_MESSAGE_TYPE_EXCEPTION, "testProto failed: invalid message type")
    return
  }
  result := YourServiceTestProtoResult{}
  if err = result.Read(iprot); err != nil {
    return
  }
  if err = iprot.ReadMessageEnd(); err != nil {
...
func NewYourServiceProcessor(handler YourService) *YourServiceProcessor {
  ...
  self8 := &YourServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self8.processorMap["sayHello"] = &yourServiceProcessorSayHello{handler:handler}
  self8.processorMap["eatApple"] = &yourServiceProcessorEatApple{handler:handler}
  self8.processorMap["testProto"] = &yourServiceProcessorTestProto{handler:handler}
return self8
}
...
type yourServiceProcessorTestProto struct {
  handler YourService
}

func (p *yourServiceProcessorTestProto) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := YourServiceTestProtoArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
    oprot.WriteMessageBegin("testProto", thrift.EXCEPTION, seqId)
    x.Write(oprot)
    oprot.WriteMessageEnd()
    oprot.Flush()
    return false, err
  ...
  iprot.ReadMessageEnd()
  result := YourServiceTestProtoResult{}
var retval *TestProtoResponse
  var err2 error
  if retval, err2 = p.handler.TestProto(); err2 != nil {
    x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing testProto: " + err2.Error())
    oprot.WriteMessageBegin("testProto", thrift.EXCEPTION, seqId)
    x.Write(oprot)
    oprot.WriteMessageEnd()
    oprot.Flush()
  ...
  if err2 = oprot.WriteMessageBegin("testProto", thrift.REPLY, seqId); err2 != nil {
    err = err2
  }
  if err2 = result.Write(oprot); err == nil && err2 != nil {
    err = err2
...
type YourServiceTestProtoArgs struct {
}

func NewYourServiceTestProtoArgs() *YourServiceTestProtoArgs {
  return &YourServiceTestProtoArgs{}
}

func (p *YourServiceTestProtoArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *YourServiceTestProtoArgs) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("testProto_args"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
  }
  if err := oprot.WriteFieldStop(); err != nil {
...
func (p *YourServiceTestProtoArgs) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("YourServiceTestProtoArgs(%+v)", *p)
}

// Attributes:
//  - Success
type YourServiceTestProtoResult struct {
  Success *TestProtoResponse `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewYourServiceTestProtoResult() *YourServiceTestProtoResult {
  return &YourServiceTestProtoResult{}
}

var YourServiceTestProtoResult_Success_DEFAULT *TestProtoResponse
func (p *YourServiceTestProtoResult) GetSuccess() *TestProtoResponse {
  if !p.IsSetSuccess() {
    return YourServiceTestProtoResult_Success_DEFAULT
  }
return p.Success
}
func (p *YourServiceTestProtoResult) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *YourServiceTestProtoResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *YourServiceTestProtoResult)  ReadField0(iprot thrift.TProtocol) error {
  p.Success = &TestProtoResponse{}
  if err := p.Success.Read(iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Success), err)
  }
  return nil
...
func (p *YourServiceTestProtoResult) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("testProto_result"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField0(oprot); err != nil { return err }
  }
...
func (p *YourServiceTestProtoResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
    if err := p.Success.Write(oprot); err != nil {
...
func (p *YourServiceTestProtoResult) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("YourServiceTestProtoResult(%+v)", *p)
}
